    ...
    <nav class="uk-navbar-container" style="background-color: #80CDC0;" uk-navbar>
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                <li class="uk-active"><a href="#" style="color:white; padding:30px; font-size: 40px;font-family:rockwell;">Bepress</a></li>
                </li>
                <?php
            ...
            <table class="uk-table uk-table-hover uk-table-divider">
                <thead>
                    <tr>
                        ...
                        <th style="color:black;">Merk Motor</th>
                        <th style="color:black;">Nama Motor</th>
                        <th>
                            <center>
                                <button class="uk-button btn-primary" type="submit" onclick="location.href='tambah_motor.php'"
                                    <?php
                ...
                <tbody>
                    ...
                    foreach ($data as $baris) { ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a class="uk-button uk-button-danger" href="action/act_hapus_motor.php?no_polisi=<?php echo $baris['no_polisi'] ?>">Hapus</a>
                                </center>
                            </td>
                        </tr>
                    <?php   }
