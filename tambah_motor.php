    ...
    <nav class="uk-navbar-container" style="background-color: #80CDC0;" uk-navbar>
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                <li class="uk-active"><a href="profil_motor.php" style="color:white; padding:30px; font-size: 40px;font-family:rockwell;">Bengkel Ku</a></li>
                </li>
                <?php
    ...
    <div class="uk-container" style="padding-top:25px;">
        ...
        <div class="uk-container">
            <form class="uk-form-stacked" action="action/act_tambah_motor.php" method="post">
                ...
                <button class="uk-button btn-primary" type="submit" name="button">TAMBAH MOTOR</button>
